...
<head>
    ...
    <title>XovenHost - Our Space Your Ways</title>
    <link id="theme-style" href="assets/css/main.css" as="style" rel="stylesheet" />
    <link id="theme-style" href="assets/css/xoven.css" as="style" rel="stylesheet" />
                    ...
                    <div id="navBar" class="collapse navbar-collapse">
                        <ul class="navbar-nav ms-auto main-navbar-nav">
                            ...
                            <li class="nav-item custom-nav-item">
                                <a class="nav-link custom-nav-link"  href="index.php" >
                                    Home
                                </a>
                            </li>
                            ...
                            <li class="nav-item hs-has-mega-menu custom-nav-item position-relative" data-position="center">
                                <a id="hostingMegaMenu" class="nav-link custom-nav-link " href="JavaScript:Void(0);" aria-haspopup="true" aria-expanded="false">
                                    Hosting <i class="fa fa-angle-down" aria-hidden="true"></i>
                                </a>
                                <!-- Demos - Mega Menu -->
                                                ...
                                                <div class="title-with-icon-item">
                                                    <a class="title-with-icon-link" href="https://portal.xovenhost.com/index.php?rp=/store/vps-server">
                                                        <div class="d-flex align-items-center">
                                                            <div class="menu-item-icon pe-3">
                                                                <i
                                class="fa fa-cloud-upload rounded-circle twitter-bg"
                              ></i>
                                                            </div>
                                                            <div class="media-body">
                                                                <span class="u-header__promo-title">
                            ...
                            <!--domain start-->
                            <li class="nav-item hs-has-mega-menu custom-nav-item position-relative" data-position="center">
                                <a id="domainMegaMenu" class="nav-link custom-nav-link" href="JavaScript:Void(0);" aria-haspopup="true" aria-expanded="false">
                                    Domain <i class="fa fa-angle-down" aria-hidden="true"></i>
                                </a>
                                <!-- Demos - Mega Menu -->
                            ...
                            <!--about start-->
                            <li class="nav-item hs-has-mega-menu custom-nav-item position-relative" data-position="center">
                                <a id="aboutMegaMenu" class="nav-link custom-nav-link" href="JavaScript:Void(0);" aria-haspopup="true" aria-expanded="false">
...
<!--                                     
                            ...
                            <li class="nav-item header-nav-last-item d-flex align-items-center">
                                <a class="btn btn-tertiary animated-btn" href="https://portal.xovenhost.com/clientarea.php" target="_blank">
